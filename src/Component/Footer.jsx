    ...
    return (
        <footer className=" text-gray-600 text-sm py-6 text-center">
            <div className="container mx-auto flex flex-col items-center space-y-3">
                {/* Links */}
                <div className="flex flex-wrap justify-center gap-4 md:flex md:space-x-8 font-nunito">
                    <a href="#" className="text-[#758b9d] border-b-1 hover:border-none ">{t('contacts')}</a>
                    <a href="#" className="text-[#758b9d] border-b-1 hover:border-none  ">{t('aml_kyc_policy')}</a>
                    <a href="#" className="text-[#758b9d] border-b-1 hover:border-none ">{t('payment_policy')}</a>
                    <a href="#" className="text-[#758b9d] border-b-1 hover:border-none ">{t('terms_conditions')}</a>
                    <a href="#" className="text-[#758b9d] border-b-1 hover:border-none ">{t('privacy_policy')}</a>
                    <a href="#" className="text-[#758b9d] border-b-1 hover:border-none ">{t('information_disclosure')}</a>
                </div>
